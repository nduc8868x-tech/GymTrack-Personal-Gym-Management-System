...
```
✅ 6.1  BE: aiService.ts — Groq API integration (meta-llama/llama-4-scout-17b), build context from user data
...
⬜ 6.5  BE: Groq API timeout handling + fallback error response
